...
import Head_bgs from "../assets/lala2.jpeg";
...
export default function Fifth_SP() {
  ...
  const messages = [
    "Velia E. Dunn from Salem, OR just qualified for $5,400 Allowance Card",
    "Paul N. Parsons from Petersburg, VA just qualified for $5,400 Allowance Card.",
    "Paul N. Parsons from New Town, ND just qualified for $5,400 Allowance Card.",
    "Mary T. Pritts from Oakland, CA just qualified for $5,400 Allowance Card.",
  ];
  ...
  const notify = (message: any) => {
    ...
    const specialAmounts = ["$5,400", "$5,400", "$5,400", "$5,400"];
          ...
          <div className="main-container-5">
            <div className="main-descrition-5">
              <div className="main-des-title-6-test">
                ...
                <b>
                  ...
                  <span style={{ backgroundColor: "#fde047" }}>
                    The $5,400 Health Credits Subsidy in 2024.
                  </span>{" "}
                  Here's how!
                </b>
              </div>
              ...
              <div className="main-des-5">
                ...
                Subsidy that gives them up to $5,400. Americans can use the funds
              ...
              <div className="main-des-5" style={{ marginTop: "1rem" }}>
                ...
                <b>
                  you will have your $5,400 Health Credits mailed to you within
          ...
          {eligible ? (
            <div className="checking">
              ...
              <div className="top-description-5">
                Make A <b>Quick Call</b> Activate Your <b>$5,400 Subsidy</b>{" "}
            ...
            <div className="checking">
              Sorry, You're not eligible for the $5,400 Health Credits Subsidy!
            </div>
          )}
