  ...
  const reviews = [
    {
      ...
      paragraph: "I couldn't believe my luck when I received the $1400 subsidy card...",
      name: 'Paula A.',
    },
    {
      headline: 'A Real Game-Changer',
      paragraph: "I was hesitant at first when I heard about the $1400 subsidy card...",
      name: 'Daniel F.',
    },
    {
      headline: 'Peace of Mind for Expenses',
      paragraph: "I never thought I would qualify for the $1400 subsidy card...",
      name: 'Jorge Pulido',
    },
  ];
